...
def diffusion_curvature(X):
    ...
    return dcurv # shaped (n,)

"""
Copied from https://github.com/KrishnaswamyLab/CurveNet/blob/29c112a9f56508bb981b95bcbcc7b242bcad3440/lazy_diffusion_curvature.py
"""
